...
<%
List<Object[]> awardslist = (List<Object[]>)request.getAttribute("Awardslist");
Object[] empdata = (Object[])request.getAttribute("Empdata");
%>
<div class="card-header page-top ">
		<div class="row">
			<div class="col-md-6">
				<h5>Awards List <small><b>&nbsp;&nbsp; - &nbsp;&nbsp;<%if(empdata!=null){%><%=empdata[0]%> (<%=empdata[1]%>)<%}%></b></small></h5>
			</div>
				<div class="col-md-6">
					<ol class="breadcrumb ">
		...
		<%} %>
			...
			<div class="card" >
				...
				<div class="card-body " >
					...
					<form action="AwardsAddEditDelete.htm" method="post" id="empForm">
				<div align="right">
						...
						<div class="table-responsive">
                               ...
                               <tbody>
                              <%if(awardslist!=null && awardslist.size()>0){ for(Object[] award:awardslist){%>
                             
	                          <tr> 
	                             <td align="center"> <input type="radio" name="AwardId"  value="<%=award[0]%>" ></td>
                                 <td> <%=award[2]%>  </td>
                                 <td> <%=award[3]%>  </td>
                                 <td> <%=award[4]%>  </td>
                                 <td> <%=award[12]%> </td>
                                 <td> <%=award[7]%>  </td>
                                 <td align="center"> <%if(award[5]!=null){%> <%=DateTimeFormatUtil.SqlToRegularDate(award[5].toString())%> <%}%> </td>
                              <% } } %>
                            </tr>
                           </tbody> 
							</table>
 ...
 function Edit(myfrm) {
		...
		var fields = $("input[name='AwardId']").serializeArray();
