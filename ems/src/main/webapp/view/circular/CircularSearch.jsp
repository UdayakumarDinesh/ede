...
<%String fromdate = (String)request.getAttribute("fromdate");
	String todate = (String)request.getAttribute("todate"); %>
	        ...
	        <div class="card-header" style="height: 4rem">
	              <form action="CircularSearch.htm" method="POST"> 
	                   <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
					      <div class="row justify-content-center">
							    ...
							    <div class="col-2" style="margin-left:4%">
                                     <input type="text" placeholder="Search Circular" name="search" autocomplete="off" style=" width: 205%;padding: 5px;border-left: none;border-top: none;border-right: none;border-down: black;"></div>
                                <div class="col-1" style="margin-left:13%"><button type="submit" id="button" formaction="CircularSearch.htm"><i class="fa fa-search"></i></button></div>
