			...
			<div class="card" style="padding-top:0px;margin-top: -15px;">
				...
				<div class="" style="padding: 0.5rem 1rem;margin:10px 0px 5px 0px;">
								...
								<%if(inventoryqty[32]!=null){ %>
								 <div style="margin-left:500px;"><span style="border: 0px;font-weight: 600">Date :&nbsp;<span class="text-blue" ><%=rdf.format(sdf.parse(inventoryqty[32].toString())) %></span> </span>
								</div>
								<%} %>
