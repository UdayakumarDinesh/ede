...
<body>
<%
List<Object[]>  tourapplylist = (List<Object[]>)request.getAttribute("applyStatuslist");
...
<div class="container-fluid">	
      <form action="TourApplyStatus.htm" method="post"  class="navbar-form navbar-right"  style="margin-top:8px;">
