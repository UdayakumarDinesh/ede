...
%>
						...
						<!-- main header -->
							<div class="col-md-2" style="margin-top: -10px;margin-bottom: -10px;">
								...
								<div class="form-group">
									<label>Month</label> 
									<select name="ClaimMonth"	class="form-control input-sm" style="width: 100px;"
											required="required">
								...
								<div class="col-md-2" style="margin-top: -10px;margin-bottom: -10px;">
									<div class="form-group">
										<label>Year</label> <input type="text" name="ClaimYear"	class="form-control input-sm selectYear" style="width: 70px;" maxlength="4" required="required"> &nbsp;&nbsp;
									</div>
								</div>
								<div class="col-md-2" style="margin-top: -10px;margin-bottom: -10px;">
								<!-- //Year -->
				...
				<div class="card" >
					<div class="card-body" style="padding: 0px;">
						<div class="col-md-12 text-center">
							<br> <b>RE-IMBURSEMENT OF TELEPHONE BILL</b><br> <b>CABS,Banglore</b>
						</div>
						...
						<div class="col-md-12">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center"><input type="text"
											name="FromDate" class="form-control input-sm currentdate"
											style="width: 85px;" maxlength="10" required="required">
										</td>
										<td><input type="text" name="ToDate"
											class="form-control input-sm currentdate"
											style="width: 85px;" maxlength="10" required="required">
										</td>

										<td><input type="text" value="<%=DeviceName%>"
											class="form-control input-sm" style="width: 45px;"
											readonly="readonly"></td>

										<td><input type="text" value="<%=DeviceNumber%>"
											class="form-control input-sm" style="width: 90px;"
											readonly="readonly"> <input type="hidden"
											name="TeleUsersId" value="<%=TeleUsersId%>"></td>

										<td><input type="text" name="BillNo"
											class="form-control input-sm " style="width: 100px;"
											required="required" maxlength="100"></td>

										<td><input type="text" name="BillDate"
											class="form-control input-sm currentdate"
											style="width: 85px;" maxlength="10" required="required">
										</td>
										<td><input type="text" name="BasicAmount"
											class="form-control input-sm amount" style="width: 120px;"
											maxlength="6" required="required" onkeydown="crossCheck();"
											onclick="crossCheck();" onfocus="crossCheck();"></td>
										<td><input type="text" name="TaxAmount"
											class="form-control input-sm  tax" style="width: 120px;"
											required="required" readonly="readonly"></td>
										<td><input type="text" name="TotalAmount"
											class="form-control input-sm total" style="width: 120px;"
											required="required" readonly="readonly"></td>
									</tr>
									<%count++;}}%>
								</tbody>
							...
							<div class="col-md-12 text-right">
								...
								<%if(TeleSpecialpermission!=null){%><%="1416"%>
								<%}else{%><%=PayLevelAndTeleRectrictAmt[6]%>
								<%}%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Total
						...
						<button id="submit" class="btn btn-sm btn-success" style="margin-left: 20px;" name="TeleAddClaimSave" value="TeleAddClaimSave">submit</button>
	...
	<script
		src="${pageContext.request.contextPath}/stresource/dist/js/app.min.js"></script>
...
function myFunction() {
   ...
   document.getElementById("grossTotal").value=Math.round(GrossTotal);
