			...
			<div class="col-md-3">
				...
				<div class="col-md-9 ">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active " aria-current="page">Telephone Approval</li>
					</ol>
				</div>
			</div>
		 </div>
           ...
           <table  class="table table-bordered  table-striped  table-hover table-condensed ">
            ...
            <%for(Object[] ls:TelephoneApprovalList){ %>
             ...
             <tr>
                    ...
                    <td><%=ls[3] %></td>
                    <td><%=ls[4] %></td>
                    <td style="word-wrap: break-word;"><%if("A".equalsIgnoreCase(ls[7].toString())){%><%=ls[8] %><%}else{ %>--<%} %></td>
                    <td><textarea name="remark<%=ls[6]%>"  rows="1" cols="20"  maxlength="90"></textarea></td>
                    <td>    
                       <span class="app">
                            <label >Approve</label>
                              <input type="checkbox" name="TeleApproveAction" value="<%=ls[6]%>" checked>
                       </span>
                           <input type="hidden" name="PayableAmount<%=ls[6]%>"    value="<%=ls[4]%>">
                   </td>
           </tr>
           <%count++;} }%><!-- for closed -->
           </tbody>
