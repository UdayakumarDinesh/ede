		...
		<table style="margin-left:10px; margin-top:15px;width:660px; border-collapse: collapse;width: 660px;">
			<tr>
				<td style="text-align:center; height:50px;border: 1px solid black;" width="100px"  ><div
					style="font-size: 40px;  font-style: italic;"><img style="width: 80px; height: 80px; margin-top: -40px;margin-left: 10px;" align="left"   <%if(lablogo!=null ){ %> src="data:image/*;base64,<%=lablogo%>" alt="Configuraton"<%}else	{ %> alt="File Not Found" <%} %>></div></td>
				<td style="text-align:center; height:50px;border: 1px solid black;" width="800px" ><span style="font-weight:bold;font-size:14px; text-transform: uppercase;"><%if(lab!=null) %> <%=lab.getLabName()%></span>
			    ...
			    <div align="center">
			      <span style="" >&nbsp;(A Unit of SITAR)</span> <br>
			      <span style="font-weight:bold;" >&nbsp;A Government of India</span> <br>
			      <span><%if(lab!=null){ %><%=lab.getLabAddress()+", "+lab.getLabCity()+" - "+lab.getLabPin() %><%} %></span>
			    </div>
				<!-- <div align="left" style=""> 
		         ...
		         -->
				<%-- <div style="margin-top:-70px;margin-left: 320px !important;"align="left"> 
						        <span >Phone &nbsp;&nbsp;: +91-080-2565 9802</span><br>
				...
				<div align="right">
				   <span style="margin-left: 32px;"><b>Phone &nbsp;&nbsp;: <%if(lab!=null) {%><%=lab.getLabTelNo()%><%} %></b> </span><br>
				   <%-- <span style="margin-left: 32px;"><b> <%if(lab!=null) {%><%=lab.getLabTelNo()%><%} %></b> </span><br> --%>
				   <span><b>e-mail &nbsp;&nbsp;: <%if(lab!=null) {%><%=lab.getLabEmail()%><%} %></b> </span><br>
				</div>
				</td>
