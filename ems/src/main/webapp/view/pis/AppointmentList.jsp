...
<%
List<Object[]> appointmentlist = (List<Object[]>)request.getAttribute("Appointmentlist");
Object[] empdata = (Object[])request.getAttribute("Empdata");
%>
<div class="card-header page-top ">
		<div class="row">
			<div class="col-md-6">
				<h5>Appointment List <small><b>&nbsp;&nbsp; - &nbsp;&nbsp;<%if(empdata!=null){%><%=empdata[0]%> (<%=empdata[1]%>)<%}%></b></small></h5>
			</div>
				<div class="col-md-6">
					<ol class="breadcrumb ">
		...
		<%} %>
			...
			<div class="card" >
				...
				<div class="card-body " >
					...
					<form action="AppointmentAddEditDelete.htm" method="post" id="empForm">
				<div align="right">
						...
						<div class="table-responsive">
				   			<table class="table table-bordered table-hover table-striped table-condensed"  id="myTable"> 
								...
								<tbody>
									<%if(appointmentlist!=null && appointmentlist.size()>0){ for(Object[] obj : appointmentlist){ %>
										<tr>
									    	 <td align="center"><input type="radio" name="AppointmentId"  value="<%=obj[0]%>" ></td>
			                                 <td> <%=obj[7]%> </td>
			                                 <td> <%=obj[2]%> </td>
			                                 <td> <%=obj[3]%> </td>
			                                 <td> <%=obj[5]%> </td>
 ...
 function Edit(myfrm) {
		...
		var fields = $("input[name='AppointmentId']").serializeArray();
