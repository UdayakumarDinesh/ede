...
<body >
	<div id="pageborder" align="center" style="max-width:100%;margin-top: -5px;margin-left: 10px;" >
		<div align="right">
			<h3 style="text-decoration: underline;">CHSS FORM - 1</h3>
		</div>
		<div align="center">
			<h3>Contributory Health Service Scheme of SITAR Society</h3>
			<span style="text-decoration: underline; font-size: 15px;">APPLICATION FOR INITIAL ADMISSION TO CHSS</span>
		</div>
		<div align="left">
			<h3>UNIT : STARC</h3>
		</div>
		<div align="left">
			<table>
				<tr>
					...
					<th style="width: 5% " >Level In Pay Matrix</th>
