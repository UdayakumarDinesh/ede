...
List<Object[]> FwdMemberDetails = (List<Object[]>)request.getAttribute("CHSSEligibleFamList");
		...
		<div align="left">
			...
			<table>
				...
				<tr>
					...
					<td><%=FwdMemberDetails.get(i)[7] %></td>
					...
					<td>
						<%if(FwdMemberDetails.get(i)[10]!=null){ %>
							<%=FwdMemberDetails.get(i)[10] %>
						<%}%>
					</td>
					<td>
						<%if(FwdMemberDetails.get(i)[11]!=null && !FwdMemberDetails.get(i)[11].toString().equals("0")){ %>
