...
<%
List<Object[]> propertylist = (List<Object[]>)request.getAttribute("Propertylist");
Object[] empdata = (Object[])request.getAttribute("Empdata");
%>
<div class="card-header page-top ">
		<div class="row">
			<div class="col-md-6">
				<h5>Property List <small><b>&nbsp;&nbsp; - &nbsp;&nbsp;<%if(empdata!=null){%><%=empdata[0]%> (<%=empdata[1]%>)<%}%></b></small></h5>
			</div>
				<div class="col-md-6">
					<ol class="breadcrumb ">
		...
		<%} %>
			...
			<div class="card" >
				...
				<div class="card-body " >
					...
					<form action="PropertyAddEditDelete.htm" method="post" id="empForm">
				<div align="right">
						...
						<div class="table-responsive">
							 ...
							 <thead> 
                               ...
                               <tbody>
                              <%for(Object[] ls:propertylist){%>
                              
                              
	                             
	                          <tr> 
	                             <td align="center"><input type="radio" name="PropertyId"  value="<%=ls[1]%>" ></td>
                                 <td> <%if("Y".equalsIgnoreCase(ls[2].toString())){out.println("MOVABLE");}else{out.println("IMMOVABLE");}%></td>
                                 <td> <%=ls[6]%> </td>
                                 <td> <%=ls[4]%> </td>
                                 <td> <%=ls[3]%> </td>
                                 <td align="center"> <%if(ls[5]!=null){%> <%=DateTimeFormatUtil.SqlToRegularDate(ls[5].toString())%> <%}%> </td>
                                 <td align="center"> <%if(ls[7]!=null){%> <%=DateTimeFormatUtil.SqlToRegularDate(ls[7].toString())%> <%}%> </td>
 ...
 function Edit(myfrm) {
		var fields = $("input[name='PropertyId']").serializeArray();
