			...
			<div class="card-body"  >
              ...
              <div class="row">
				        ...
				        <div class="form-group">
		                     ...
		                     <input type="text" value="<%if(nextkin!=null&&nextkin.getNextkin_addr()!=null){%><%=nextkin.getNextkin_addr()%><%}%>" class="form-control input-sm" maxlength="255" id="nextKinAdd" name="nextKinAdd" required="required" placeholder="Enter Permanent Address" onclick="return trim(this)" onchange="return trim(this)"> 
		                </div>
		                </div>
         	...
         	<div class="row">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" id="city" name="city" class="form-control input-sm" maxlength="49"  value="<%if(nextkin!=null&&nextkin.getCity()!=null){%><%=nextkin.getCity()%><%}%>" placeholder="Enter City."   required="required" onclick="return trim(this)" onchange="return trim(this)">
                    </div>
                    </div> 
...
function CommentsModel()
{
	  ...
	  if(NextKinAdd==null || NextKinAdd=='' || NextKinAdd=="null" ){
			alert('Enter the Next Kin Address!');
			return false;
