			...
			<%if(billid>0){ %>
						...
						<div class="row" id="tab-scroll-sh" align="center">
													...
													{ %>
														...
														%>
															<tr>
																...
																<td class="right" style="width: 10%;border-right:none;"><%=pkgitem[4] %></td>
								...
								<!-- ----------------------------- consultation ---------------------------------- -->		
												<% 
													...
													{ %>
														<%if(i==1){ %>
															<tr>
															    <td style="margin-right:none;"></td>
																<td colspan="4" style="text-align: center;margin-left:none''">
							...
							<!-- ----------------------------- miscellaneous ---------------------------------- -->
										...
										<tr>
											<td colspan="8" class="text-blue">(In words Rupees <%=awc.convert1(itemstotal.setScale(0, BigDecimal.ROUND_HALF_UP).longValue()) %> Only)</td> 
										</tr>
										...
										<tr>
											<th colspan="8" style="text-align: center;">Attachments </th>
										</tr>
										
										<tr>
											<th style="width:5%;text-align:center;  " >SN</th>
											<th colspan="6" style="width:50%;" >Type of Document(s)	</th>
