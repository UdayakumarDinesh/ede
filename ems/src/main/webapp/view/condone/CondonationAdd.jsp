...
<div class="page card dashboard-card" style="background: transparent;">
   <div class="card-body" >
		...
		<form action="#" method="POST" id="CondoneForm" enctype="multipart/form-data">
          	...
          	<div class="card" style="padding-top:0px;margin-top: -15px;">
				<div class="card-body main-card " style="padding-top:0px;"  align="center">
							...
							<td style="width: 30%; height: 75px;border: 0;vertical-align: bottom;">
								...
								<select class="form-control" name="condone_type" style="width: 80%; float: right;">
									<%for(SEIPCondoneType type : CondoneTypesList){ %>
										<option value="<%=type.getCondoneTypeId()%>"><%=type.getCondoneType() %></option>
									<%} %>
								</select>
							</td>
						</tr>
					...
					<table style="border: 0px; width: 100%">
						...
						<tr>
							<td>
								<input type="text" class="subject-input" name="condone_subject" value="" maxlength="255">
							</td>
						</tr>
						<tr>
							<th><br>Body : </th>
						...
						<tr>
							<td colspan="2">
								<textarea class="form-control" name="condone_content" maxlength="5000" style="width: 100%;" rows="20"></textarea>
							</td>
						</tr>
					</table>	
					<br><br>
					...
					<!-- <div class="row" align="left">
						...
						<table class="table" style="width: 50%" >
							<thead>
								<tr>
									<th style="width: 90%;">Attachments</th>
					...
					<input type="hidden" name="EmpNo" value="<%=EmpNo %>" >
		          	<div class="row" align="center">
		            	<div class="col-md-12">
		            		<button type="submit" class="btn btn-sm add-btn" formaction="CondoneAddSubmit.htm"  formmethod="post" onclick="return confirm('Are You sure to Submit');">SAVE</button>
		            	</div>
					</div>
				</div>
			</div>
