					...
					<form action="#" method="POST" id="CondoneForm" >
						...
						<input type="hidden" name="CondoneId" value="<%=condoneData[0] %>" >
			          	<div class="row" align="center">
			            	<div class="col-md-12">
			            		<textarea rows="7" style="width: 100%;" name="remarks"></textarea>
				            	<%if(Statuses.contains(condoneData[2].toString())){ %>
				            		<button type="submit" class="btn btn-sm submit-btn" name="action" value="F" formaction="CondoneForward.htm"  formmethod="post" onclick="return confirm('Are You sure to Forward');">Forward</button>
				            	<%}else if(isApproval!=null && isApproval.equalsIgnoreCase("Y")){ %>
				            		<button type="submit" class="btn btn-sm submit-btn" name="action" value="F" formaction="CondoneForward.htm"  formmethod="post" onclick="return confirm('Are You sure to Forward');">Forward</button>
				            		<button type="submit" class="btn btn-sm btn-danger" name="action" value="R" formaction="CondoneForward.htm"  formmethod="post" onclick="return confirm('Are You sure to Return');">Return</button>
				            	<%} %>
			            	</div>
						</div>
					</form>
